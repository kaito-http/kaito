...
An older version of kaito did not have `.get`, `.post`, etc. Instead you'd write `.add('GET', '/', ...)`. This older api is deprecated and you can expect it to be removed in the near future.
