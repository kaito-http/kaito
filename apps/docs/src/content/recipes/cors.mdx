...
`experimental_createCORSTransform()` returns an object with `.before` and `.transform` methods that you can pass directly to your router. It also provides methods for dynamic origin management:
