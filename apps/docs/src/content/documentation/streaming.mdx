...
SSE is a technology that allows you to stream data to the client in realtime. You can [learn about it on MDN](https://developer.mozilla.org/en-US/docs/Web/API/Server-sent_events/Using_server-sent_events).
