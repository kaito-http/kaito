...
<Callout>
	We're using `Bun.serve()` in this example, which is an API specific to the Bun runtime. The next page will show you
	how to use Kaito with other runtimes like Node.js, Deno, etc.
</Callout>
