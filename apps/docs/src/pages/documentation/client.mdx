...
For endpoints that return Responses, you must pass `response: true` to the request options. This is enforced for you at a compile time type level, so you
